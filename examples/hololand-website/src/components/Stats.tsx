        ...
        <div className="glass rounded-3xl p-12">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-gray-300">
              Thousands are already building the open metaverse
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <div className="text-gray-400">NPM Packages</div>
            </div>
            ...
            <div className="text-center">
              ...
              <div className="text-gray-400">Working Examples</div>
            </div>
          ...
          <div className="mt-12 pt-8 border-t border-white/10">
            <div className="flex flex-wrap justify-center gap-6">
              ...
              <a
                href="https://discord.gg/hololand"
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-2 text-gray-300 hover:text-primary transition"
              >
              ...
              <a
                href="https://twitter.com/HololandDev"
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-2 text-gray-300 hover:text-primary transition"
              >
