...
| **Twin Universe** | [twin-universe/](./twin-universe/) | `.holo` | First playable game-layer slice for real-world anchors, consent, and receipts |
| **Native Authoring** | [native-authoring-pipeline/](./native-authoring-pipeline/) | `.holo`, `.json` | Source-authored asset pack, world assembly, encounter, NPC, item arc, shard flow, receipts, and local runtime validation |
