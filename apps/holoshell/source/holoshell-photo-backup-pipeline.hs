...
// family-photo-backup-custody-pipeline.hs (2026-05-21) to committed source.
// Paths updated to point at apps/holoshell/source/ production locations.
...
object "FamilyPhotoBackupCustodyPipelineManifest" {
  ...
  id: "holoshell-family-photo-backup-custody"
  name: "HoloShell Family Photo Backup Custody Pipeline"
  version: "0.1.0"
  shell: "HoloShell"
  sourceLayer: "HoloScript"
  roomSource: "apps/holoshell/source/holoshell-photo-backup-room.holo"
  policySource: "apps/holoshell/source/holoshell-photo-backup-policy.hsplus"
  pipelineSource: "apps/holoshell/source/holoshell-photo-backup-pipeline.hs"
  receiptPack: "PhotoBackupCustodyReceipt"
...
object "ReplaySealStep" {
  ...
  output: ".tmp/holoshell/photo-backup-replay-seal-latest.json"
}
