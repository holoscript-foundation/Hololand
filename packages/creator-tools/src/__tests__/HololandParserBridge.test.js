...
describe('HololandParserBridge', () => {
    ...
    describe('Memory Estimation', () => {
        ...
        it('should vary memory by property complexity', () => {
            ...
            expect(result2.metadata?.estimatedMemory).toBeGreaterThanOrEqual(result1.metadata?.estimatedMemory || 0);
        });
    });
    ...
    describe('Integration Scenarios', () => {
        ...
        it('should handle multi-device registration', () => {
            const devices = [
                { ...mockDeviceContext, deviceId: 'iphone', gpuCapability: 'low' },
                { ...mockDeviceContext, deviceId: 'ipad', gpuCapability: 'medium' },
                { ...mockDeviceContext, deviceId: 'quest', gpuCapability: 'medium' },
                { ...mockDeviceContext, deviceId: 'visionpro', gpuCapability: 'high' },
                { ...mockDeviceContext, deviceId: 'hololens', gpuCapability: 'medium' },
                { ...mockDeviceContext, deviceId: 'rtx4090', gpuCapability: 'extreme' },
            ];
