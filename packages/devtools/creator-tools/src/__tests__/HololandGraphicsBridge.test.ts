 ...
 */
const mockTraitConfig: TraitConfig = {
  id: 'trait_test_001',
  name: 'TestMaterial',
 ...
 */
const mockRenderingContext: Omit<GraphicsRenderingContext, 'deviceId'> = {
  maxTextureSize: 4096,
 ...
 */
const mockMetrics: Omit<RenderingMetrics, 'averageFrameTimeMs' | 'fps'> = {
  frameTimeMs: 16.67,
  drawCallCount: 100,
...
describe('HololandGraphicsBridge', () => {
  let bridge: HololandGraphicsBridge;
  let mockEditor: TraitAnnotationEditor;
  let mockEngine: RealtimePreviewEngine;
  ...
  describe('Device Optimization', () => {
    ...
    it('should support multi-device optimization', () => {
      const materials = ['iphone-15', 'ipad-pro', 'quest-3'].map(device => 
        bridge.createMaterialFromTrait(mockTraitConfig, device as any)
      );
  ...
  describe('Material Management', () => {
    ...
    it('should handle multiple traits', () => {
      ...
      const trait2: TraitConfig = { ...mockTraitConfig, id: 'trait_002', name: 'OtherTrait' };
  ...
  describe('Integration Scenarios', () => {
    ...
    it('should support multi-device optimization workflow', () => {
      const devices = ['iphone-15', 'ipad-pro', 'quest-3'];
      const materials = devices.map(device =>
        bridge.createMaterialFromTrait(mockTraitConfig, device as any)
      );
