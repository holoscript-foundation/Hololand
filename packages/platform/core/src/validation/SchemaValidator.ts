...
const BUILTIN_CONSTRAINTS: readonly TraitConstraint[] = [
  ...
  // Conflict Rules
  {
    ...
    message: 'Static objects cannot have physics or be interactive.',
  },
  {
    type: 'conflicts',
    source: 'kinematic',
  ...
  // Interaction Exclusivity
  {
    ...
    message: 'Objects should have one primary interaction mode.',
  },
  ...
  // Spatial Constraint Requirements
  {
    ...
    targets: ['collidable'],
    message: 'spatial_adjacent requires collidable bounds.',
  },
  {
    type: 'requires',
    source: 'spatial_contains',
    targets: ['collidable'],
    message: 'spatial_contains requires collidable bounds.',
  },
  {
    type: 'requires',
    source: 'spatial_reachable',
    targets: ['spatial_awareness'],
    message: 'spatial_reachable requires spatial_awareness.',
  },
  {
    type: 'conflicts',
    source: 'spatial_contains',
    targets: ['invisible'],
    message: 'spatial_contains containers cannot be invisible.',
  },
  {
    type: 'oneof',
    source: 'spatial_constraint_mode',
    targets: ['spatial_adjacent', 'spatial_contains'],
    message: 'Choose either spatial_adjacent or spatial_contains.',
  },
  ...
  // Spatiotemporal Constraints
  {
    ...
    targets: ['collidable'],
    message: 'spatial_temporal_adjacent requires collidable bounds.',
  },
  {
    type: 'conflicts',
    source: 'spatial_temporal_adjacent',
    targets: ['spatial_adjacent'],
    message: 'spatial_temporal_adjacent supersedes spatial_adjacent.',
  },
  {
    type: 'requires',
    source: 'spatial_temporal_reachable',
    targets: ['spatial_awareness'],
    message: 'spatial_temporal_reachable requires spatial_awareness.',
  },
  {
    type: 'conflicts',
    source: 'spatial_temporal_reachable',
    targets: ['spatial_reachable'],
    message: 'spatial_temporal_reachable supersedes spatial_reachable.',
  },
  {
    type: 'requires',
    source: 'spatial_trajectory',
    targets: ['physics'],
    message: 'spatial_trajectory requires physics.',
  },
  {
    type: 'requires',
    source: 'spatial_trajectory',
    targets: ['collidable'],
    message: 'spatial_trajectory requires collidable bounds.',
  },
  ...
  // Robotics/URDF Constraints
  {
    ...
    message: 'URDF robot models cannot have cloth, soft body, or fluid physics.',
  },
  {
    type: 'conflicts',
    source: 'urdf_robot',
    targets: ['particle_emitter'],
    message: 'URDF robot models conflict with particle emitters.',
  },
  ...
  // Cultural Profile Constraints
  {
    ...
    message: 'Norm compliance requires a cultural_profile.',
  },
  {
    type: 'requires',
    source: 'cultural_memory',
    targets: ['cultural_profile'],
    message: 'Cultural memory requires a cultural_profile.',
  },
  {
    type: 'conflicts',
    source: 'cultural_trace',
    targets: ['invisible'],
    message: 'Cultural traces must be visible for other agents to perceive them.',
  },
];
 ...
 */
export function createSchemaValidator(constraints?: readonly TraitConstraint[]): SchemaValidator {
